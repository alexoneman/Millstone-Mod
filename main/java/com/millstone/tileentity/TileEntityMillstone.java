...
import com.millstone.crafting.MillstoneRecipes;
...
public class TileEntityMillstone extends TileEntity implements ISidedInventory {
     ...
     */
        ...
        public String getInventoryName() {
                return this.hasCustomInventoryName() ? this.localizedName : "Grindstone";
        }
        ...
        private static int getItemBurnTime(ItemStack itemstack) {
                if(itemstack == null){
                        ...
                        if(item instanceof ItemBlock && Block.getBlockFromItem(item) != Blocks.air) {
                                ...
                                if(item == MillstoneMod.woodGear) return 200;
                                if(item == MillstoneMod.stoneGear) return 400;
                                if(item == MillstoneMod.ironGear) return 800;
                                if(item == MillstoneMod.diamondGear) return 6000;
             ...
             /*   if(this.isBurning()) {
                ...
                if(!this.worldObj.isRemote) {
                        ...
                        if(flag != this.isBurning()) {
                                flag1 = true;
                                Millstone.updateMillstoneState(this.burnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
                        }
                }
                if(flag1) {
                        this.markDirty();
